...
- **Per-transform EC tactic cache**: Read `CLAUDE_TACTIC_CACHE.md` at the start of any session involving closing per-transform EasyCrypt admits or editing `*.tactics.toml` sidecar files.
